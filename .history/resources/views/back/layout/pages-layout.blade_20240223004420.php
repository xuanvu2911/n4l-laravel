                                        ...
                                        <table class="table text-nowrap">
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-label-primary rounded-pill badge-center p-3 me-2"><i class="bx bx-mobile-alt bx-xs"></i></span>
                                                        Smart Phone
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-label-warning rounded-pill badge-center p-3 me-2"><i class="bx bx-mouse bx-xs"></i></span>
                                                        Mouse
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-label-info rounded-pill badge-center p-3 me-2"><i class="bx bx-desktop bx-xs"></i></span>
                                                        Computer
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-label-danger rounded-pill badge-center p-3 me-2"><i class="bx bx-tv bx-xs"></i></span>
                                                        Smart TV
                                                    </td>
                                                    <td>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <small class="text-muted">You have done <span class="fw-medium">57.6%</span> more sales.<br />Check your new badge in
                                                your profile.</small>
                                            <div>
